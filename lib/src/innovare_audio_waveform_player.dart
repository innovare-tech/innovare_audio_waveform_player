...
class _InnovareAudioWaveformPlayerState
    extends State<InnovareAudioWaveformPlayer>
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      ...
      child: ConstrainedBox(
        constraints:
            BoxConstraints(maxWidth: maxWidth, minHeight: widget.height),
        child: Container(
...
class _WaveformPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paintFg = Paint()
      ..shader =
          (gradient ?? LinearGradient(colors: [accentColor, accentColor]))
